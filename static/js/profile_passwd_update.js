$(document).ready(function() {
		$("#show_hide_password0 span").on('click', function(event) {
			event.preventDefault();
			if($('#show_hide_password0 input').attr("type") == "text"){
				$('#show_hide_password0 input').attr('type', 'password');
				$('#show_hide_password0 span').addClass( "fa-eye" );
				$('#show_hide_password0 span').removeClass( "fa-eye-slash" );
			}else if($('#show_hide_password0 input').attr("type") == "password"){
				$('#show_hide_password0 input').attr('type', 'text');
				$('#show_hide_password0 span').removeClass( "fa-eye" );
				$('#show_hide_password0 span').addClass( "fa-eye-slash" );
			}
		});
	});
